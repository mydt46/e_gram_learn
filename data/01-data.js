...
const words = [
    {
        ...
        content: [
            {
                use: "Không bao giờ rơi vào âm /ə/hoặc là âm /əʊ/.",
                practice: [
                ]
            },
            {
                use: "Thường rơi vào nguyên âm dài/nguyên âm đôi hoặc âm cuối kết thúc với nhiều hơn một phụ âm.",
                practice: [
                ]
            },
            {
                use: "Nếu tất cả các âm mà ngắn hết thì trọng âm rơi vào âm tiết thứ nhất.",
                practice: [
                ]
            }
        ],
