...
const words = [
  {
    title: "Thì tương lai đơn - The simple future tense",
    content: [
      {
      ...
      {
        use: "Dự đoán không có căn cứ",
        practice: [
          {
            sentence_vi: "(Tôi nghĩ là cô ấy sẽ đến cuộc họp đúng giờ.)",
            sentence_en: "I think she will come to the meeting on time. ",
          },
        ],
      },
    ],
