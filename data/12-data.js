...
const words = [
  {
    title: "Thì tương lai hoàn thành - the perfect future tense",
    content: [
      {
        use: "Hoàn thành trước một thời điểm trong tương lai",
        practice: [
          {
            sentence_vi: "(Chúng ta sẽ trả xong nợ vào tháng 8.)",
            sentence_en: "We will have paid the loan by August",
          },
        ],
      },
      {
        use: "Hoàn thành trước một hành động khác trong tương lai.",
        practice: [
          {
            sentence_vi:
