...
const words = [
  {
    title: "Thì quá khứ hoàn thành - the past perfect tense",
    content: [
      {
        use: "những hành động đã xảy ra và hoàn thành trước hành động khác trong quá khứ",
        practice: [
          {
            sentence_vi:
    ...
    translate: [
      {
        ...
        practice: [
          {
            sentence_vi: "Hôm qua họ về nhà sau khi đã hoàn thành công việc.",
            sentence_en:
              "Yesterday they went home after they had finished their work.",
          },
          {
            sentence_vi:
          ...
          {
            sentence_vi: "Họ về nhà sau khi đã hoàn thành việc học.",
          ...
          {
            sentence_vi: "Trước khi đi ngủ, anh ấy đã làm bài tập về nhà.",
          ...
          {
            sentence_vi: "Sau khi họ đã đi, tôi ngồi xuống và nghỉ ngơi.",
            sentence_en: "After they had gone, I sat down and rested.",
          },
        ],
      },
      {
